...
- ![3-rank](../Winter_study/image/4th/3-rank.png)


#### DENSE_RANK()
- 같은 값이면 같은 순위를 부여, 다음 순위는 연속됨(ex. 1, 2, 2, 3...)
- ![3-dense_rank](../Winter_study/image/4th/3-dense_rank.png)

#### ROW_NUMBER()
- 동일한 값이 있어도 무조건 1, 2, 3, 4 순서 부여
- ![3-row_number](../Winter_study/image/4th/3-row_number.png)
...
FROM ANIMAL_INS;
```
![문제1](../Winter_study/image/4th/문제1.png)
...
ORDER BY ANIMAL_ID;
```
![문제3](../Winter_study/image/4th/문제3.png)
...
ORDER BY I.DATETIME
```
![린터1](../Winter_study/image/4th/린터1.png)
...
```
![린터2](../Winter_study/image/4th/린터2.png)
...
ORDER BY ID
```
![린터3](../Winter_study/image/4th/린터3.png)
